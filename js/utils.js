...
var utils = (function () {
    ...
    /**
     * lastChild:获取到最后一个子节点
     * @param newEle
     * @param container
     */

    function lastChild(newEle, container) {

    }

    /**
     *insetAfter:把一个新元素添加到一个老元素的后面(insetBefore:添加到老元素前面,等价于Js中的insertBefore)
     * @param newEle
     * @param oldEle
     */
    ...
    function insetAfter(newEle, oldEle) {
        var xO = next(oldEle);
        var p = oldEle.parentNode;
        if (xO) {
            p.insertBefore(oldEle, xO);
        }
